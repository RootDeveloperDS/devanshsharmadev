 ...
 */
// ⚡ Bolt: Wrap purely visual component in React.memo to prevent unnecessary re-renders
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      rafId = requestAnimationFrame(() => {
        // ⚡ Bolt: Compute rect lazily in RAF instead of eagerly on scroll to avoid layout thrashing
