...
function ChannelItem({ icon: Icon, label, value, href, copy }: typeof channels[0]) {
  ...
  return (
    <div className="bento-card group flex items-center justify-between gap-3 !p-3 hover:border-primary/60 sm:gap-4 sm:!p-4 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 ring-offset-background transition-colors">
      <a
        href={href}
        ...
        className="flex min-w-0 flex-1 items-center gap-3 sm:gap-4 focus-visible:outline-none"
      >
      ...
      {copy && (
        <button
          type="button"
          onClick={handleCopy}
          className="shrink-0 text-muted-foreground transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm p-1"
