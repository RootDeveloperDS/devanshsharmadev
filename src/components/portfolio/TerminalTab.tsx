          ...
          >
            <div>
              ...
              <input
                ...
                required
                className="mt-2 w-full rounded-md border border-border bg-background/50 px-3 py-2 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 ring-offset-background transition-all"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                required
                className="mt-2 w-full resize-none rounded-md border border-border bg-background/50 p-3 text-foreground placeholder:text-muted-foreground/50 outline-none focus:border-primary focus:ring-2 focus:ring-primary focus:ring-offset-2 ring-offset-background transition-all"
              />
            </div>
