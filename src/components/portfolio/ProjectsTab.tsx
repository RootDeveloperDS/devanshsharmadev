            ...
            <div className={`mt-4 flex flex-wrap gap-4 ${project.span === "lg" ? "" : "mt-2"}`}>
              {project.github && (
                <a
                  ...
                  className={`group inline-flex items-center gap-2 font-medium text-primary transition-all duration-200 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background rounded-sm ${project.span === "lg" ? "text-sm" : "text-xs"}`}
                >
                  <Github className={`transition-transform duration-200 group-hover:scale-110 ${project.span === "lg" ? "h-4 w-4" : "h-3.5 w-3.5"}`} /> {project.id === "jarvis" ? "Mark 1 → 21" : "GitHub"}
                </a>
              )}
              {project.live && (
                <a
                  ...
                  className={`group inline-flex items-center gap-2 font-medium text-primary transition-all duration-200 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background rounded-sm ${project.span === "lg" ? "text-sm" : "text-xs"}`}
                >
                  <ArrowUpRight className={`transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 ${project.span === "lg" ? "h-4 w-4" : "h-3.5 w-3.5"}`} /> Live Demo
                </a>
              )}
            </div>
          </motion.article>
