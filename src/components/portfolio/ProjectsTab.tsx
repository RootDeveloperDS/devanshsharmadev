            ...
            <div className={`mt-4 flex flex-wrap gap-4 ${project.span === "lg" ? "" : "mt-2"}`}>
              {project.github && (
                <a
                  ...
                  className={`inline-flex items-center gap-2 font-medium text-primary hover:gap-3 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background rounded-sm ${project.span === "lg" ? "text-sm" : "text-xs"}`}
                >
