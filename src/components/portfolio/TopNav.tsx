...
export const TopNav = memo(function TopNav({ active, onChange, onOpenPalette }: Props) {
  return (
    <header className="fixed inset-x-0 top-0 z-40 px-2 sm:px-4">
      <div className="mx-auto mt-2 sm:mt-3 flex max-w-6xl items-center justify-between gap-1 sm:gap-3 rounded-full glass px-2 py-1.5 sm:px-4 sm:py-2">
        ...
        <Link
          ...
          className="flex items-center gap-1.5 sm:gap-2 group shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background rounded-full p-1 active:scale-95 transition-transform"
          ...
          {tabs.map((t) => {
            ...
            return (
              <Link
                ...
                onMouseEnter={() => {
                  // ⚡ Bolt: Prefetch lazy-loaded chunks on hover to reduce perceived navigation latency
                  if (t.id === "projects") import("@/components/portfolio/ProjectsTab");
                ...
                className="relative px-2 py-1 sm:px-3 sm:py-1.5 text-xs font-medium tracking-wide focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ring-offset-background rounded-full active:scale-95 transition-transform"
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" sideOffset={8}>
              <span className="font-mono text-[10px] tracking-wider uppercase">100% Open Source</span>
            </TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" sideOffset={8}>
              <span className="font-mono text-[10px] tracking-wider uppercase">
                Command Palette <span className="text-primary/70 ml-1">⌘K</span>
              </span>
            </TooltipContent>
          </Tooltip>
