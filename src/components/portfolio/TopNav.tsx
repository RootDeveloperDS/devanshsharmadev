...
export const TopNav = memo(function TopNav({ active, onChange, onOpenPalette, paletteOpen }: Props) {
  return (
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <a
                ...
                aria-label="View Portfolio Open Source Code on GitHub. Opens in new tab"
              >
